...
class Translator:
    PROMPT = "{texts} translate {lang} manhwa dialogue to english. Don't return anything else. return only list of translated text. in json format {{\"data\":[\"translation1\",\"translation2\"]}}"
